...
BENCHMARK_ARGS=()
if [[ "${1:-}" == --help || "${1:-}" == -h ]]; then
    printf 'Usage: native/scripts/benchmark-core.sh [--environment | --map <blacksite|nebelwacht|sundkai> [--spray on|off] [--water on|off] [--enemies 9] [--seed 1745] [--seconds 60] [--samples 5] [--grenades]]\n'
    exit 0
fi
