...
[[ -s "$NATIVE_DIR/Assets/maps/nebelwacht/CREDITS.txt" ]] || {
    printf 'Missing Nebelwacht source credits: native/Assets/maps/nebelwacht/CREDITS.txt. Restore this tracked file before building.\n' >&2
    exit 1
}
